...
public class Employee {
     ...
     * @param correo
     */
    public Employee(String dni, String nombre,
    ...
    */
     ...
     * @param ruta
     */
    public void asignarRuta(Route ruta){
       this.ruta =ruta;
    }
   ...
   public void asignarDniAleatorio(){
    ...
    public void asignarRutaAleatorio() {
        int rutaAleatorio = generador.nextInt(Route.values().length);
        // Se asigna el ruta
        ruta =(Route.values())[rutaAleatorio];
    }
